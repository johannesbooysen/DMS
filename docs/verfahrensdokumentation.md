...
### [`tests/sicherung.test.ts`](../tests/sicherung.test.ts)

- meldet nichts, solange sie unversehrt ist
- merkt es, wenn ein Ereignis nachtraeglich veraendert wurde
- merkt es, wenn ein Ereignis herausgeschnitten wurde
- rechnet unabhaengig von der Zeitzone des Servers
- meldet nichts, solange alles greift
- merkt es, wenn die RLS an einer Tabelle abgeschaltet ist
- merkt es, wenn ein Unveraenderlichkeits-Trigger fehlt
- meldet nichts, solange Datei und Hash zusammenpassen
- merkt es, wenn die Datei fehlt
- merkt es, wenn die Datei eine andere geworden ist
- nennt keinen Ablageschluessel in der Meldung
